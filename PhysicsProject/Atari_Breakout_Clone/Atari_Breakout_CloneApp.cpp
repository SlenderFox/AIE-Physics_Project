...
Atari_Breakout_CloneApp::Atari_Breakout_CloneApp()
{
}
...
bool Atari_Breakout_CloneApp::startup()
{
...
void Atari_Breakout_CloneApp::shutdown()
{
	delete m_font;
	delete m_2dRenderer;
}

void Atari_Breakout_CloneApp::update(float deltaTime)
{
	// input example
...
void Atari_Breakout_CloneApp::draw()
{
